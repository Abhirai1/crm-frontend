...
const KanbanBoard = ({ session }) => {
  ...
  const fetchTasks = async () => {
    try {
      ...
      const response = await fetch(
        `https://crm-backend-5kkb.onrender.com/api/tasks?employee_id=${session.employeeId}`
      );
  ...
  const fetchAvailableTechnicians = async () => {
    try {
      const response = await fetch('https://crm-backend-5kkb.onrender.com/api/installation-technicians');
      if (!response.ok) {
  ...
  const updateTaskStatus = async (taskId, newStatus) => {
    try {
      ...
      const response = await fetch(
        `https://crm-backend-5kkb.onrender.com/api/tasks/${taskId}/status`,
        {
          method: 'PATCH',
          headers: {
  ...
  const openTaskModal = async (task) => {
    ...
    if ((isRegisterTask || isCommissionTask || isIntentTask) && task.application_id) {
      ...
      try {
        const response = await fetch(
          `https://crm-backend-5kkb.onrender.com/api/register-applicant/${task.application_id}`
        );
        if (response.ok) {
  ...
  const handleIntentDocumentUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://crm-backend-5kkb.onrender.com/api/register-applicant/${selectedTask.application_id}/intent`,
        {
          method: 'PATCH',
          body: formData,
        }
      ...
      const docsResponse = await fetch(
        `https://crm-backend-5kkb.onrender.com/api/register-applicant/${selectedTask.application_id}`
      );
      if (docsResponse.ok) {
  ...
  const handleCommissionDocumentUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://crm-backend-5kkb.onrender.com/api/register-applicant/${selectedTask.application_id}/commission`,
        {
          method: 'PATCH',
          body: formData,
        }
  ...
  const handleSaveInstallationDetails = async () => {
    ...
    try {
      ...
      const response = await fetch('https://crm-backend-5kkb.onrender.com/api/installation-details', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleSaveRegisterApplicantFiles = async () => {
    ...
    try {
      ...
      const response = await fetch('https://crm-backend-5kkb.onrender.com/api/register-applicant', {
        method: 'POST',
        body: formData,
      });
                      ...
                      <div className="bg-slate-50 rounded-lg p-4">
                        ...
                        {registerApplicantDocs?.application_form_url && (
                          <div className="mt-2 flex items-center gap-2">
                            ...
                            <a 
                              href={`https://crm-backend-5kkb.onrender.com${registerApplicantDocs.application_form_url}`}
                              target="_blank"
                      ...
                      <div className="bg-slate-50 rounded-lg p-4">
                        ...
                        {registerApplicantDocs?.feasibility_form_url && (
                          <div className="mt-2 flex items-center gap-2">
                            <span className="text-xs text-green-600">✓ Uploaded</span>
                            <a 
                              href={`https://crm-backend-5kkb.onrender.com${registerApplicantDocs.feasibility_form_url}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-xs text-blue-600 hover:underline"
                            >
                      ...
                      <div className="bg-slate-50 rounded-lg p-4">
                        ...
                        {registerApplicantDocs?.subsidy_form_url && (
                          <div className="mt-2 flex items-center gap-2">
                            <span className="text-xs text-green-600">✓ Uploaded</span>
                            <a 
                              href={`https://crm-backend-5kkb.onrender.com${registerApplicantDocs.subsidy_form_url}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-xs text-blue-600 hover:underline"
                            >
                      ...
                      <div className="bg-slate-50 rounded-lg p-4">
                        ...
                        {registerApplicantDocs?.plan_commissioning_form_url && (
                          <div className="mt-2 flex items-center gap-2">
                            <span className="text-xs text-green-600">✓ Uploaded</span>
                            <a 
                              href={`https://crm-backend-5kkb.onrender.com${registerApplicantDocs.plan_commissioning_form_url}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-xs text-blue-600 hover:underline"
                            >
                    ...
                    <div className="bg-slate-50 rounded-lg p-4">
                      ...
                      {registerApplicantDocs?.intent_document_url && (
                        <div className="mt-3 flex items-center gap-2 p-3 bg-green-50 rounded-lg border border-green-200">
                          ...
                          <a 
                            href={`https://crm-backend-5kkb.onrender.com${registerApplicantDocs.intent_document_url}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs text-blue-600 hover:underline"
                          >
                    ...
                    <div className="bg-slate-50 rounded-lg p-4">
                      ...
                      {registerApplicantDocs?.commission_doc_url && (
                        <div className="mt-3 flex items-center gap-2 p-3 bg-green-50 rounded-lg border border-green-200">
                          <span className="text-xs text-green-600 font-semibold">✓ Uploaded</span>
                          <a 
                            href={`https://crm-backend-5kkb.onrender.com${registerApplicantDocs.commission_doc_url}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs text-blue-600 hover:underline"
                          >
