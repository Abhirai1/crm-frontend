...
export default function NewApplication({ session, applicationId = null, mode = 'create' }) {
  ...
  const getCurrentLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        setMsg('Unable to get location. Please check GPS permissions.')
        setLocationLoading(false)
      },
        ...
        <div className="space-y-2">
          <div className="relative">
            <img
              src={previews[name]}
              alt={label}
              className={`w-full h-32 md:h-40 object-cover rounded-lg border-4 ${
                blurStatus[name] ? 'border-red-500' : 'border-green-500'
              }`}
            />
            {blurStatus[name] && (
          ...
          <button
            ...
            className={`w-full py-2 md:py-2.5 rounded-lg font-medium text-sm text-white ${
              blurStatus[name]
        ...
        <form onSubmit={submit} className="space-y-5 md:space-y-6">
          ...
          <section className="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-slate-200">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-slate-700 mb-1.5">Site Location (GPS)</label>
                <button
                  type="button"
              ...
              {form.site_address && (
                <div className="md:col-span-2 bg-green-50 border border-green-200 rounded-lg p-4">
                  <p className="text-xs text-green-800 font-semibold mb-2">📍 Location Captured:</p>
                  <p className="text-sm text-green-700 mb-2">{form.site_address}</p>
                  <p className="text-xs text-green-600">
                    Coordinates: {form.site_latitude}, {form.site_longitude}
                  </p>
                </div>
              )}
            </div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <button
                    ...
                    className={`py-2.5 px-4 rounded-lg font-medium text-sm transition-all ${
                      form.name_correction_required === 'Not Required'
              ...
              <div className="border border-slate-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <button
                    ...
                    className={`py-2.5 px-4 rounded-lg font-medium text-sm transition-all ${
                      form.load_enhancement_required === 'Not Required'
                        ? 'bg-green-600 text-white shadow-md'
                        : 'bg-slate-100 text-slate-600 border border-slate-300 hover:bg-slate-200'
                    }`}
                  >
              ...
              <div className="border border-slate-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`py-2.5 px-4 rounded-lg font-medium text-sm transition-all ${
                      form.special_finance_required === 'No'
                        ? 'bg-green-600 text-white shadow-md'
                        : 'bg-slate-100 text-slate-600 border border-slate-300 hover:bg-slate-200'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`py-2.5 px-4 rounded-lg font-medium text-sm transition-all ${
                      form.special_finance_required === 'Yes'
